...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: "https://www.mida-polska.pl/polityka-prywatnosci",
  },
};
        ...
        <div className={styles.container}>
          ...
          <div className={styles.content}>
            ...
            <section>
              ...
              <ul>
                <li>
                  Obsługi zapytań i zgłoszeń przesyłanych przez formularze
                  kontaktowe i rekrutacyjne.
                </li>
                <li>
                  Prowadzenia procesów rekrutacyjnych dla kierowców
                  współpracujących z aplikacjami Bolt, Uber i FREENOW.
                </li>
            ...
            <section>
              ...
              <p>
                Każdy Użytkownik ma prawo dostępu do treści swoich danych oraz
                prawo ich sprostowania, usunięcia, ograniczenia przetwarzania,
                prawo do przenoszenia danych, prawo wniesienia sprzeciwu. W celu
                realizacji swoich praw, Użytkownik może skontaktować się z
            ...
            <section>
              ...
              <p>
                Strona główna może wykorzystywać pliki cookies, czyli małe pliki
                tekstowe wysyłane do komputera internauty identyfikujące go w
                sposób potrzebny do uproszczenia lub umorzenia danej operacji.
                Cookies są nieszkodliwe dla komputera, dla jego użytkownika i
                jego danych. Warunkiem działania cookies jest ich akceptacja
                przez przeglądarkę i nie usuwanie ich z dysku.
              </p>
            </section>
          </div>
        </div>
